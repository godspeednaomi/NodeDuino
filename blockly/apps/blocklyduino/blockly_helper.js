...
function uploadCode(code, callback) {
    ...
    request.onreadystatechange = function() {
        ...
        case 200:
            break;
        case 0:
            errorInfo = "code 0\n\n無法連線至伺服器位址 " + url + ".  請確認本地端網頁伺服器使否開啟";
            break;
        case 400:
            errorInfo = "code 400\n\n建置失敗 - 可能為程式原始碼錯誤.  請確認是否有未連接之積木方塊.";
            break;
        case 500:
            errorInfo = "code 500\n\n上傳失敗.  開發板是否有接上USB連接埠?";
            break;
        case 501:
            errorInfo = "code 501\n\n上傳失敗.  是否未安裝Arduino IDE工具?";
            break;
        default:
...
function uploadClick() {
    var code = Blockly.Arduino.workspaceToCode();//get code from arduino editor textarea
